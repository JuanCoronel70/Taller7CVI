...
// Estructura para la configuración de multitextura (igual que en tu código original)
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Control de cámara (moviéndose con WASD, mouse, etc.)
        ...
        for (int i = 0; i < 12; i++) {
            ...
            // Ajuste de escala según el objeto (igual que en tu código original)
            if (i >= 5 && i < 9)
